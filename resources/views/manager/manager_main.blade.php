    ...
    <div class="container mx-auto p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-lg flex flex-col h-full" style="min-height: 600px;">
                ...
                <div id="recent-activities-container" class="overflow-y-auto flex-grow border border-gray-200 rounded-lg p-4" style="max-height: 550px;">
...
activitiesChannel.bind('new-activity', function(data) {
    ...
    // Append new activity at the TOP
    ...
    // Ensure scrolling appears when list grows
    let container = document.getElementById('recent-activities-container');
    container.style.overflowY = "auto";

    // Check if "No recent activity" message exists, remove it
    let noActivityMessage = document.querySelector('.text-gray-500.text-center');
