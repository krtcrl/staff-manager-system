...
# Final Request Rejected

Hello {{ $notifiable->name }},

@component('mail::panel')
**Final Request Code:** {{ $finalRequest->unique_code }}  
**Part Number:** {{ $finalRequest->part_number }}  
**Part Name:** {{ $finalRequest->part_name }}  
**Rejected By:** Final Manager {{ $managerNumber }}  
...
This request has been **rejected** and will not proceed further in the approval workflow.
