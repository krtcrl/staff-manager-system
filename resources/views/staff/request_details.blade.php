...
<div class="h-screen flex flex-col overflow-hidden">
    ...
    <div class="flex-1 overflow-y-auto p-2 pb-6">
        ...
        <div class="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl shadow-md hover:shadow-lg border border-gray-300 dark:border-gray-600 transition duration-300 ease-in-out">
    ...
    <a href="{{ route('download.attachment', ['filename' => rawurlencode($request->attachment)]) }}" 
       target="_blank" 
       class="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-full shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors no-loading">
        Download
