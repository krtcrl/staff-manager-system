                        ...
                        <div class="mt-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="standardYieldPercentage" name="standardYieldPercentage" x-model="standardYieldPercentage" class="w-full px-3 py-2 border rounded focus:ring focus:ring-blue-300 mt-1" placeholder="Enter %" step="0.01">
                                </div>

                                <!-- Standard Yield ($/hr) -->
                                <div>
                                    <label for="standardYieldDollarPerHour" class="block text-sm font-medium text-gray-700">($/hr)</label>
                                    <input type="number" id="standardYieldDollarPerHour" name="standardYieldDollarPerHour" x-model="standardYieldDollarPerHour" class="w-full px-3 py-2 border rounded focus:ring focus:ring-blue-300 mt-1" placeholder="Enter $/hr" step="0.01">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="actualYieldPercentage" name="actualYieldPercentage" x-model="actualYieldPercentage" class="w-full px-3 py-2 border rounded focus:ring focus:ring-blue-300 mt-1" placeholder="Enter %" step="0.01">
                                </div>

                                <!-- Actual Yield ($/hr) -->
                                <div>
                                    <label for="actualYieldDollarPerHour" class="block text-sm font-medium text-gray-700">($/hr)</label>
                                    <input type="number" id="actualYieldDollarPerHour" name="actualYieldDollarPerHour" x-model="actualYieldDollarPerHour" class="w-full px-3 py-2 border rounded focus:ring focus:ring-blue-300 mt-1" placeholder="Enter $/hr" step="0.01">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('modalComponent', () => ({
                ...
                revisionType: '',
                uph: '',
                standardYieldPercentage: '', // Standard Yield (%)
                standardYieldDollarPerHour: '', // Standard Yield ($/hr)
                actualYieldPercentage: '', // Actual Yield (%)
                actualYieldDollarPerHour: '', // Actual Yield ($/hr)
                description: '',
                ...
                submitForm() {
                    ...
                    if (!this.selectedPart || !this.uph || !this.revisionType || !this.standardYieldPercentage || !this.standardYieldDollarPerHour || !this.actualYieldPercentage || !this.actualYieldDollarPerHour) {
                    ...
                    formData.append('standard_yield_percentage', this.standardYieldPercentage); // Add Standard Yield (%)
                    formData.append('standard_yield_dollar_per_hour', this.standardYieldDollarPerHour); // Add Standard Yield ($/hr)
                    formData.append('actual_yield_percentage', this.actualYieldPercentage); // Add Actual Yield (%)
                    formData.append('actual_yield_dollar_per_hour', this.actualYieldDollarPerHour); // Add Actual Yield ($/hr)
                ...
                resetForm() {
                    ...
                    this.revisionType = '';
                    this.uph = '';
                    this.standardYieldPercentage = ''; // Reset Standard Yield (%)
                    this.standardYieldDollarPerHour = ''; // Reset Standard Yield ($/hr)
                    this.actualYieldPercentage = ''; // Reset Actual Yield (%)
                    this.actualYieldDollarPerHour = ''; // Reset Actual Yield ($/hr)
                    this.description = '';
                    const attachmentInput = document.getElementById('attachment');
