...
<!-- Pre Approval Link -->
<li class="mb-2">
    <a href="{{ route('staff.prelist') }}" class="flex items-center p-2 transition-all duration-300 rounded relative group {{ request()->routeIs('staff.main') ? 'text-blue-400 font-semibold shadow-lg' : 'text-gray-400 hover:text-white' }}">
        <svg :class="sidebarOpen ? 'w-5 h-5 mr-2 transform transition-transform duration-200' : 'w-8 h-8 mx-auto'" 
            xmlns="http://www.w3.org/2000/svg" 
            fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
