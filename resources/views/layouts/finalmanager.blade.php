...
<head>
    ...
    <title>Final Approval Manager Dashboard</title>
    ...
    <div class="flex min-h-screen">
        ...
        <div :class="sidebarOpen ? 'w-64' : 'w-20'" class="bg-gray-800 text-white transition-all duration-300 min-h-screen">
            <div class="p-4 flex justify-between items-center">
                <h2 :class="sidebarOpen ? 'block' : 'hidden'" class="text-lg font-semibold">Final Approval Manager</h2>
            ...
            <ul class="mt-4">
                <li class="mb-2">
                    <a href="{{ route('finalmanager.dashboard') }}" class="flex items-center p-2 hover:bg-gray-700 rounded">
                        <!-- Dashboard Icon -->
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between h-16 items-center">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-900 focus:outline-none">
                            <span>{{ Auth::guard('finalmanager')->user()->name ?? 'Final Approval Manager' }}</span>
